-- FUNCTION: code_src.update_source2(text, numeric, numeric, text)

-- DROP FUNCTION code_src.update_source2(text, numeric, numeric, text);

CREATE OR REPLACE FUNCTION code_src.update_source2(
	v_info text,
...
ALTER FUNCTION code_src.update_source2(text, numeric, numeric, text) OWNER TO network;
GRANT EXECUTE ON FUNCTION code_src.update_source2(text, numeric, numeric, text) TO anchorto_run
