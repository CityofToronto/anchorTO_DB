-- FUNCTION: code_src.update_source_dm_h(numeric, numeric)

-- DROP FUNCTION code_src.update_source_dm_h(numeric, numeric);

CREATE OR REPLACE FUNCTION code_src.update_source_dm_h(
	v_id numeric,
...
ALTER FUNCTION code_src.update_source_dm_h(numeric, numeric) OWNER TO network;
GRANT EXECUTE ON FUNCTION code_src.update_source_dm_h(numeric, numeric) TO anchorto_run
